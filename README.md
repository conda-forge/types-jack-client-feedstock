About types-jack-client-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-jack-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-jack-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-jack-client
# for installing globally
pixi global install types-jack-client
```
...
It is possible to list all of the versions of `types-jack-client` available on your platform:
...
```
pixi search types-jack-client --channel conda-forge
```
