...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-jack-client-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13136&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-jack-client-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-jack-client` can be installed with:

```
conda install types-jack-client
```

It is possible to list all of the versions of `types-jack-client` available on your platform with:
